//Base 100% Editable creditos a Enebott 
...
const color = (text, color) => { return !color ? chalk.green(text) : chalk.keyword(color)(text) };
 ...
 //baner
const banner = cfonts.render("ENE| Bot| Base", {
  font: 'pallet',
  align: 'center',
  gradient: ["green","blue"]
})
...
🥂 Que tu estancia esté llena de risas, buena platica y alguna que otra amistad

📜 Recuerda echarle un ojo a nuestras reglas para evitar cualquier problema
